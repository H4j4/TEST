...
br.addheaders = [('User-Agent','Mozilla/5.0 (Linux; Android 11; TECNO KF6i) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.61 Mobile Safari/537.36')]
...
\033[1;91m☞ Auther     : NIRINA_OFFISIALY_HACKER
\033[1;92m☞ WhatsApp   : 0329941389
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCYe7sbHW1HfvkV4h-1Cdf-w
...
def mb():
	...
	if bm =='':
	    ...
	    time.sleep(2)
	    os.system('cd $HOME/TEST_TUTO && python2 TEST.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/Nirina.haja.95')
	    menu()
	elif bm =='4':
